...
fruitbiomass <- read.csv("~/Desktop/PhD Work/elicitor work/clean data/fruit_biomass_squash2022.csv")
...
guild.data <-  read.csv("~/Desktop/PhD Work/elicitor work/clean data/guild_data_squash2022_clean.csv")
...
herbivory.data <- read.csv("~/Desktop/PhD Work/elicitor work/clean data/herbivory_squash2022.csv")
str(herbivory.data)
...
plantbiomass <- read.csv("~/Desktop/PhD Work/elicitor work/clean data/plant_biomass_squash2022_clean.csv")
...
taxon.data <- read.csv("~/Desktop/PhD Work/elicitor work/clean data/taxon_data_squash2022clean.csv")
...
plant_mortality <- read_csv("plant_mortality.csv")
